        ...
        <AuthProvider>
          ...
          <div className="container">
            ...
            <Switch>
              ...
              {/* The exact and Switch make sure that the component only displays if its the exact link and not anything with a '/' in the link*/}
...
const Home = () => {
  return (
    <div className="WelcomeMessage">
      {" "}
      Welcome to Knuckleball, a super easy app tracker for your soccer stats.
      Are you a coach? Well, you're in luck! You can make multiple users for
      each team member and keep track of everyone here at once.
    </div>
  );
};
