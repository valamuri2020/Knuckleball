...
import CreateStatsStyles from './create-stats.component.css'

export default class CreateStats extends Component{
    constructor(props){
        super();
        this.state = {
            username: '',
    ...
    onSubmit(e){
        ...
        console.log(stats);
         ...
         axios.post('http://localhost:5000/stats/add', stats)
      ...
      render(){
        return (
          <div>
          <h3>Enter Today's Statistics</h3>
          <form onSubmit={this.onSubmit}>
            <div className="form-group"> 
              ...
              <select ref="userInput"
                ...
                <div className="form-group">
                  <input type="submit" value="Edit Stats Log" className="btn btn-primary" />
                </div>
              </form>
            </div>
            )
